...
class UpdateOpportunityRequest extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            'data.attributes.apem-sales-person'       => 'required',
            'data.attributes.sra-sales-rep'           => 'sometimes',
            'data.attributes.distributor-salesperson' => 'sometimes',
            'data.attributes.industry'                => 'required',
            'data.attributes.application'             => 'required',
            'data.attributes.reason-for-opp'          => 'required',
            ...
            'data.attributes.product-type'            => 'required',
            'data.attributes.product-series'          => 'required',
            ...
            'data.attributes.current-supplier'        => 'required',
            'data.attributes.competitors'             => 'required',
            'data.attributes.year1-sales-vol'         => 'required',
            'data.attributes.year2-sales-vol'         => 'required',
            'data.attributes.year3-sales-vol'         => 'sometimes',
            'data.attributes.currency'                => 'sometimes',
            'data.attributes.target-sales-price'      => 'required',
            'data.attributes.potential-annual-rev'    => 'sometimes',
            'data.attributes.probability-of-win'      => 'required',
